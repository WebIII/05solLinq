...
namespace SportsStore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IEnumerable<ProductViewModel> pvm = products.Select(p =>
            ...
            {
                Console.WriteLine("{0} {1} woont in {2}", c.FirstName, c.Name, c.CityName);
            }
            Console.ReadLine();
            #endregion
            ...
            {
                Console.WriteLine("{0} {1} woont in {2} en heeft {3} bestellingen", c.FirstName, c.Name, c.CityName, c.HasOrders ? "" : "geen");
            }
            Console.ReadLine();
            #endregion
